...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    if (errorParam === 'AccessDenied') {
      setError('Access denied. Only @patsgroup.id accounts are allowed.')
      setIsLoading(false)
    }
    ...
    if (errorParam && !['AccessDenied', 'CredentialsSignin', 'credentials'].includes(errorParam)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Use native form POST to NextAuth callback — ensures browser handles Set-Cookie from redirect
