        ...
        <AnimatePresence>
          {showAddMenu && (
            <motion.div
              ...
              className="absolute bottom-full left-1/2 z-20 mb-4 w-[calc(100vw_-_3rem)] max-w-sm -translate-x-1/2 rounded-[2rem] border-none bg-surface-container-highest p-3 shadow-2xl shadow-primary/20"
            >
